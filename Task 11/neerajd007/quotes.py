	...
	"quote": "The great secret of education is to direct vanity to proper objects."},
{
	...
	"quote": "It is not that travel just broadens your mind, rather it enables you to see how narrow your oppressor minds are."},
{
	"author": "Alan Watts",
...
{
	"author": "Alan Watts",
	"quote": "Life is a musical thing and you are supposed to dance and sign while it is being played."},
{
	"author": "Alan Watts",
	"quote": "Omnipotence is not knowing how everything is done; it is just doing it."},
{
	"author": "Albert Camus",
...
def quote_random():
	...
	response= Response(
	json.dumps(quotes[rand]), status=10)
	return response
